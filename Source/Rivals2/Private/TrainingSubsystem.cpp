...
UTrainingSubsystem::UTrainingSubsystem() {
    ...
    this->bAutoRestoreCpu = true;
    this->bAutoRestorePlayer = true;
    this->bLoopPlayback = true;
    this->CurrentRecordingFrame = -1;
    this->RecordingStartFrame = -1;
    this->CurrentRecordingSlot = -1;
    this->CurrentPlayerIndex = -1;
    this->CpuRecordingIndex = -1;
    this->CpuPlaybackIndex = -1;
    this->CpuRecordingFacingDir = (ERivalsFacingDirection)0;
    this->CpuPlaybackMode = ERivalsCpuPlaybackMode::Record;
    this->PlaybackSequences.AddDefaulted(5);
    this->RecordedSlots = 0;
    this->PlaybackSlots = 0;

#include "PlayerSlotNetworkSettingsTab.h"

UPlayerSlotNetworkSettingsTab::UPlayerSlotNetworkSettingsTab() {
    this->BP_DelayFramesButton = NULL;
...
void UPlayerSlotNetworkSettingsTab::ToggleRenderInterpolationMethod() {
}

...
enum class EAzureVmSize : uint8 {
    ...
    pfenum_Standard_D2ads_v5,
    pfenum_Standard_D4ads_v5,
    pfenum_Standard_D8ads_v5,
    pfenum_Standard_D16ads_v5,
    ...
    pfenum_Standard_D2d_v5,
    pfenum_Standard_D4d_v5,
    pfenum_Standard_D8d_v5,
    pfenum_Standard_D16d_v5,
    pfenum_Standard_D32d_v5,
    pfenum_Standard_D2ds_v5,
    pfenum_Standard_D4ds_v5,
    pfenum_Standard_D8ds_v5,
    pfenum_Standard_D16ds_v5,
    pfenum_Standard_D32ds_v5,
};
